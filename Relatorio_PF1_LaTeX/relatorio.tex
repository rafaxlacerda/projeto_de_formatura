...
\\[3\baselineskip]
%
\textbf{Palavras-Chave} -- Controle distribuído, Sistemas de armazenamento em baterias, Regulação de tensão, Geração fotovoltaica, Algoritmo de consenso.
\end{resumo}
...
\include{capitulos/03-ambiente}
\include{capitulos/04-cenarios}
\include{capitulos/05-controle}
