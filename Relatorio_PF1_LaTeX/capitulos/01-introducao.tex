...
A disseminação da GD, a necessidade de um gerenciamento eficiente destas 
fontes nas redes de distribuição e o melhor aproveitamento energético das 
fontes renováveis inermitentes criou demanda por Sistemas de Armazenamento 
...
Os conjuntos formados por FV e BESS favorecem um controle distribuído e automático da rede por meio dos 
...
BESS autônomos e distribuídos, torna-se necessário coordená-los, de modo que operem de forma harmoniosa 
...
\begin{itemize}
  ...
  \item elaborar cenários de penetração de recursos energéticos distribuídos (FV e BESS) por meio do método Monte Carlo;
  \item implementar o controle primário (local) baseado na funcionalidade volt/var dos inversores e o controle secundário (colaborativo, por consenso) sobre as unidades distribuídas;
