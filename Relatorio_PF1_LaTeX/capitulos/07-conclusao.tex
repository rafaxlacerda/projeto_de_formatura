...
\begin{itemize}
  ...
  \item estender a solução a redes trifásicas desequilibradas, analisando o impacto da assimetria de fases sobre o algoritmo de controle; e
  \item incorporar modelos de degradação e ciclo de vida das baterias ao laço de controle;
\end{itemize}
