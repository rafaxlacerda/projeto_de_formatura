...
\begin{figure}[!htb]
  ...
  \includegraphics[width=\textwidth,height=0.85\textheight,keepaspectratio]{fluxograma-consenso.png}
  \par\vspace{2pt}\fonte{autoria própria}
\end{figure}
...
\begin{figure}[!htb]
  ...
  \includegraphics[width=\textwidth,height=0.85\textheight,keepaspectratio]{fluxograma-monte_carlo-primario-consenso.png}
  \par\vspace{2pt}\fonte{autoria própria}
\end{figure}
