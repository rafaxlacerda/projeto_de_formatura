...
dss.Basic.ClearAll()
dss.Command('Redirect "configuracao_de_ambiente/IEEE33.dss"')
...
# ── Exporta CSV ───────────────────────────────────────────────────────────────
df_tensoes.to_csv("configuracao_de_ambiente/resultados/tensoes_barras.csv", index=False)
df_linhas.to_csv("configuracao_de_ambiente/resultados/correntes_linhas.csv", index=False)
